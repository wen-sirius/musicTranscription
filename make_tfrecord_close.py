...
def split_train_valid_and_test_files_fn(args):
    ...
    print('train={0}, test={1}, valid={2}'.format(len(training_files), len(test_files), len(validation_files)))
...
def get_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/titan_data1/zhangwen/maps-tf-close')
    parser.add_argument('--gpus', type=str, default='2')
    parser.add_argument('--test_with_30_secs', type=bool, default=False)
